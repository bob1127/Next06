      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">OEM/ODM Customer & Product Desigmner</h2>
            <p className="text-xl text-gray-600">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat.</p>
          </div>

          {/* Items */}
          <div className="max-w-sm mx-auto grid flex flex-wrap justify-center items-center  gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1"> Original Equipment Manufacturing/OEM
</h4>
              <p className="text-gray-600 text-center">按照您的規格和設計圖全程為您代工製造
</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1"> Original Design Manufacturing/ODM
</h4>
              <p className="text-gray-600 text-center">提供我們您的需求，我們也可以為您設計規格和外觀並客製化的製造
</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1"> 微型酸鹼pH檢測元件的置入</h4>
              <p className="text-gray-600 text-center">可以在您的產品設計中加入我們的酸鹼檢測模塊 </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1"> 關於水質檢測，酸鹼值相關感測器合作開發
</h4>
              <p className="text-gray-600 text-center">基於蜂鳥探針的試片架構，合作開發更多應用</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1"> IVD醫療器材合作開發
</h4>
              <p className="text-gray-600 text-center">基於蜂鳥探針的試片架構，合作開發更多應用</p>
            </div>
